...
pub fn render_list(items: &[MediaItem], flash: Option<&str>, current_site: &str, is_global_admin: bool, user_email: &str) -> String {
...
function updateDropZone(file) {{
  ...
  label.style.display = 'block';
    ...
    crate::admin_page("Media Library", "/admin/media", flash, &content, current_site, is_global_admin, user_email)
}
