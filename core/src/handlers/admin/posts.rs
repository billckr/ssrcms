...
pub async fn list(
    ...
    list_type(state, "post", q.page, admin.site_id, cs, admin.is_global_admin).await
}
...
pub async fn list_pages(
    ...
    let cs = state.site_hostname(admin.site_id);
    list_type(state, "page", q.page, admin.site_id, cs, admin.is_global_admin).await
}

async fn list_type(state: AppState, post_type: &str, page: Option<i64>, site_id: Option<Uuid>, current_site: String, is_global_admin: bool) -> Html<String> {
    let per_page = 20i64;
    ...
    Html(admin::pages::posts::render_list(&rows, post_type, None, &current_site, is_global_admin))
}
...
pub async fn new_post(
    ...
    let cs = state.site_hostname(admin.site_id);
    new_post_type(state, "post", admin.site_id, cs, admin.is_global_admin).await
}
...
pub async fn new_page(
    ...
    let cs = state.site_hostname(admin.site_id);
    new_post_type(state, "page", admin.site_id, cs, admin.is_global_admin).await
}

async fn new_post_type(state: AppState, post_type: &str, site_id: Option<Uuid>, current_site: String, is_global_admin: bool) -> Html<String> {
    ...
    Html(admin::pages::posts::render_editor(&edit, None, &current_site, is_global_admin))
}
...
pub async fn edit_post(
    ...
    let cs = state.site_hostname(admin.site_id);
    edit_post_type(state, id, admin.site_id, cs, admin.is_global_admin).await
}
...
async fn edit_post_type(state: AppState, id: Uuid, site_id: Option<Uuid>, current_site: String, is_global_admin: bool) -> impl IntoResponse {
    ...
    Html(admin::pages::posts::render_editor(&edit, None, &current_site, is_global_admin)).into_response()
}
...
pub async fn save_new(
    ...
    match crate::models::post::create(&state.db, &create).await {
        ...
        Err(e) => {
            ...
            Html(admin::pages::posts::render_editor(&edit, Some(&msg), &cs, admin.is_global_admin)).into_response()
        }
    }
}
