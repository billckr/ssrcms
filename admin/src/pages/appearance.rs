...
<div class="theme-upload-section">
  ...
  <form method="post" action="/admin/appearance/upload" enctype="multipart/form-data" class="upload-form">
    ...
    admin_page("Appearance", "/admin/appearance", flash, &content, current_site, is_global_admin)
}

pub fn render(themes: &[ThemeInfo], current_site: &str, is_global_admin: bool) -> String {
