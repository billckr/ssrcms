...
pub fn render_profile(profile: &ProfileForm, flash: Option<&str>, current_site: &str) -> String {
    let content = format!(
...
<div class="profile-container">
  ...
  <form method="POST" action="/admin/profile/change-password" class="password-form">
    ...
    crate::admin_page("My Profile", "/admin/profile", flash, &content, current_site)
}
